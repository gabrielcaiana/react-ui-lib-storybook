...
exports.CheckBox = (0, react_1.forwardRef)(({ label, name, value, color = '#34D399', ...props }, ref) => {
    ...
    return (react_1.default.createElement(style_1.Label, { onClick: readOnly ? () => { } : onChange, htmlFor: name, color: color },
        label,
        react_1.default.createElement(style_1.Box, { ...props, ref: ref, name: name, value: value }),
